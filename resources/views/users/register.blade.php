			...
			<div class="col-sm-9">
				<div class="signup-form"><!--sign up form-->
					...
					<form id="form_register" action="{{route('register')}}" method="post" enctype="multipart/form-data">
						...
						<input type="date" name="birthday" placeholder="Nhập ngày sinh" value="{{old('birthday')}}"/>
						...
						<input type="text" name="street" placeholder="Nhập số nhà và tên đường" value="{{old('street')}}"/>
						...
						<div class="col-md-12">
							...
							<div class="col-md-4">
								...
								<select name="district_id" id="inputDistrict_id" class="form-control">
									<option value="{{old('district_id')}}">--Chọn huyện/quận--</option>
								</select>
							...
							<div class="col-md-4">
								...
								<select name="ward_id" id="inputWard_id" class="form-control">
									<option value="{{old('ward_id')}}">--Chọn xã/phường--</option>
								</select>
